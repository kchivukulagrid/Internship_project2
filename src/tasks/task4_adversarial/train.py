"""Adversarial training for Task 4 (mixed original + adversarial data)."""
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Train adversarial LoRA adapter.")
...
def main() -> None:
    ...
    print("Task 4 training complete:", args.output_dir)
